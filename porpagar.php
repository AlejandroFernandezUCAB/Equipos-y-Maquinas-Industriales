...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Content Column -->
            <div class="col-md-9">
                <h2>Pedidos <small>Por pagar</small></h2>
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $query = "SELECT V_Id, V_FechaVenta, V_Total FROM Cliente,Venta WHERE (".$subQuery.")=C_Usuario AND V_Cliente=C_Id AND V_Estatus LIKE 'Por pagar' ";
                            ...
                            while($f = $result->fetch_array(MYSQLI_ASSOC)){
                                     ...
                                     echo "<td><center><a href=\"pago.php?id=".$f['V_Id']."\" class=\"btn btn-default\">Pagar</a></center></td>";
                                     echo "</tr>";
                            }
                        ?>
                        </tbody>
