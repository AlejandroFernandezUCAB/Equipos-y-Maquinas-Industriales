...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Content Column -->
            <div class="col-md-9">
                <h2>Pedidos <small>Por confirmar</small></h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <?php
                                ...
                                $query = "SELECT V_Id, V_FechaVenta, V_Total FROM Cliente,Venta WHERE (".$subQuery.")=C_Usuario AND V_Cliente=C_Id AND V_Estatus LIKE 'Por confirmar pago' ";
